...
func New(l *lexer.Lexer) *Parser {
	...
	// curToken and peekToken are both set
	p.nextToken()
	p.nextToken()
...
// if not inside of LET or RETURN
// you're inside of these
...
func (p *Parser) expectPeek(t token.TokenType) bool {
	...
	// adds an error if the expectation about the
	// parsing of the statement is not met
	p.peekError(t)
	return false
}
