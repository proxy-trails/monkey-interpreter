...
// Arguments are the values passed to function parameters
// they are expressions because: they can be function Literals,
// identifiers, INT's; etc;
...
func (ra *ReassignmentStatement) String() string {
	...
	out.WriteString(ra.Name.String())
	out.WriteString(" = ")
	out.WriteString(ra.Value.String())
	out.WriteString(";")
